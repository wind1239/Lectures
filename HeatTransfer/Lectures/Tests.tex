...
\end{enumerate}
%
\item Consider a sphere, a cylinder, a hexahedron, and a cone of equal volume made of copper. All solids are initially at the same temperature and are exposed to convection in the same environment. Which solid do you think will cool faster?
\begin{enumerate}
   \item Sphere
   \item Cylinder
   \item Hexahedron
