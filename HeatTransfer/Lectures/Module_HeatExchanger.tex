...
\begin{frame}
  \frametitle{Overall Heat Transfer Coefficient Calculations}
     ...
     \visible<4->{\begin{block}{\begin{center}Fouling Factor\end{center}}
          \begin{displaymath}
             \frc{1}{U_{i}A_{i}} = \frc{1}{U_{o}A_{o}} = \mathcal{R} \left(=\frc{1}{U A_{s}}\right) = \frc{1}{h_{i}A_{i}} + \frc{R_{\text{f,i}}}{A_{i}} + R_{\text{wall}} + \frc{R_{\text{f,o}}}{A_{o}} + \frc{1}{h_{o}A_{o}} 
          \end{displaymath}
     \end{block}}
