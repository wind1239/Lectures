...
\visible<1->{As the problem deals with a long geometry and the thermal symmetry is in the centerline, we can assume the problem as an 1D. }\visible<2->{ The radius of the cylinder is 0.1 m, thus}
    \begin{displaymath}
