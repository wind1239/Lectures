...
%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{question} 
An air stream with relative humidity of $0.01$\,kg water/kg dry air passes through a duct at the rate of $1.2$\,kg\,s$^{-1}$. In the duct the air is first heated from $5^\circ$C to $20^\circ$C by heating coils and then humidified via the injection of hot steam. Air leaves the device at $25^\circ$C with a relative humidity of $60\%$. The air pressure is $101.325$\,kPa throughout.
