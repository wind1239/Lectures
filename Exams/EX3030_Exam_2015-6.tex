...
\begin{itemize}
    ...
    \item Newmann BC at node $i=4\;\left(x = 10.0\text{cm}\right)$: ~\solmarks{1/10}
          \begin{eqnarray}
...
The discretised thermal equation,~\solmarks{1/10}
\begin{eqnarray}
...
Thus for $j=0$:~\solmarks{1/10}
         ...
         \end{eqnarray} 
         with ghost-cell, $T_{5}^{0}$ defined through the Newmann BC:~\solmarks{1/10}
         \begin{displaymath}
