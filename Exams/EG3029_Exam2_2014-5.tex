...
\begin{displaymath}
{\bf \overline{V}_{1}} = V + x_{2} \frc{d V}{dx_{1}} {\bf = 190.28 \frc{cm^{3}}{gmol}}
\end{displaymath}~\solmarks{5/20}
and
\begin{displaymath}
  {\bf \overline{V}_{2}} = V - x_{1} \frc{d V}{dx_{1}} {\bf = 49.68 \frc{cm^{3}}{gmol}}
\end{displaymath}~\solmarks{5/20}
where
\begin{displaymath}
...
and
\begin{displaymath}
\frc{dV}{dx_{1}} = V_{1}+x_{2}\left(45x_{1}+25x_{2}\right)+45x_{1}x_{2}
\end{displaymath}
}
\end{question}
