...
\end{displaymath}
using Taylor's expansion.~\marks{8}
...
\begin{enumerate}[(i)]
\item Assess the convergence of the resulting linear system;~\marks{3}
\item Calculate $C_{i}$ via $\mathcal{C} = \underline{\mathcal{A}}^{-1}b$.~\marks{9}
