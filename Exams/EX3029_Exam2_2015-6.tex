...
\end{displaymath}
For SRK with {\bf T$_{r}$=0.6977}, {\bf P$_{r}$=5.0826$\times$10$^{-2}$}, {\bf $\beta$=6.3115$\times$10$^{-3}$} and {\bf $q$=8.4663}~\solmarks{2/12}, and
$\mathbf{Z = 1 + \beta - q\beta\frc{Z-\beta}{Z^{2}+\beta Z}}$.~\solmarks{2/12}
