...
%
\item Calculate the fugacity of steam at 300$^{\circ}$C and 80 bar. For your calculations, you should use $h=$ 2785 kJ/kg, $s=$ 5.791 kJ/(kg.K) for steam at 300$^{\circ}$C and 80 bar, and $h^{\text{IG}}=$ 3077 kJ/kg, $s^{\text{IG}}=$ 9.281 kJ/(kg.K) for ideal at 300$^{\circ}$C and 0.1 bar. Given,
\begin{displaymath}
 d\mu = dG = RTd\left(\ln{f}\right).
\end{displaymath} 
Also, the molar mass of water is 18 g/mol.~\marks{7}
