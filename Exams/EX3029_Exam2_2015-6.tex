...
\end{displaymath}
For RK with {\bf T$_{r}$=0.6977}, {\bf P$_{r}$=5.0826$\times$10$^{-2}$}, {\bf $\beta$=6.3115$\times$10$^{-3}$} and {\bf $q$=8.4663}~\solmarks{2/12}. $\alpha = \sqrt{T_{r}}$, $\sigma=1$, $\epsilon=0$, $\Omega=0.08664$, $\Psi=0.42748$ and $\mathbf{Z = 1 + \beta - q\beta\frc{Z-\beta}{Z^{2}+\beta Z}}$.~\solmarks{2/12}
...
\begin{center}
{\bf $Z_{1}$ = 0.95098}~\solmarks{2/12} \\
{\bf $Z_{2}$ = 0.95086}~\solmarks{3/12} \\
$\cdots \cdots \cdots $ \\
\textcolor{red} {or use the calculator to obtain $\mathbf{Z}${\bf = 0.9509}}~\solmarks{\textcolor{red}{5/12}}. The molar volume is obtained by~\solmarks{3/12} 
\begin{displaymath}
...
%========================
\solution{ At 331 K, the saturation pressures are $\mathbf{P_{1}^{sat}=}$ {\bf 42.90 kPa} and $\mathbf{P_{2}^{sat}=}$ {\bf 70.54 kPa}.~\solmarks{2/10}

The liquid solution with $\mathbf{x_{1}=0.412}$ and $\mathbf{x_{2}=0.588}$~\solmarks{2/10} results in the following activity coefficient $\mathbf{\gamma_{1}=2.0111}$ and $\mathbf{\gamma_{2}=1.6702}$.~\solmarks{2/10}

The partial pressure of ethanol and n-hexane are,
\begin{eqnarray}
...
\begin{displaymath}
\mathbf{P } =  P_{1} + P_{2} = \mathbf{103.83}\text{ {\bf kPa}}
\end{displaymath}
And the composition of the vapour phase is~\solmarks{2/10}
\begin{displaymath}
\mathbf{y_{1} =} \frc{P_{1}}{P} = \mathbf{0.360}\;\;\text{ and } \;\; \mathbf{y_{2} = 0.640}
\end{displaymath}
