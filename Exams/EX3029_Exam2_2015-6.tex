...
\end{displaymath}
For RK with {\bf T$_{r}$=0.6977}, {\bf P$_{r}$=5.0826$\times$10$^{-2}$}, {\bf $\beta$=6.3115$\times$10$^{-3}$} and {\bf $q$=8.4663}~\solmarks{2/12}. 

$\alpha = \sqrt{T_{r}}$, $\sigma=1$, $\epsilon=0$, $\Omega=0.08664$, $\Psi=0.42748$ and \\ $\mathbf{Z = 1 + \beta - q\beta\frc{Z-\beta}{Z^{2}+\beta Z}}$.~\solmarks{2/12}
...
\begin{center}
{\bf $Z_{1}$ = 0.9510}~\solmarks{2/12} \\
{\bf $Z_{2}$ = 0.9509}~\solmarks{3/12} \\
$\cdots \cdots \cdots $ \\
\textcolor{red} {or using the calculator to obtain $\mathbf{Z}${\bf = 0.9509}}~\solmarks{\textcolor{red}{5/12}}. The molar volume is obtained by~\solmarks{3/12} 
\begin{displaymath}
