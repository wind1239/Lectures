...
\item Solution Thermodynamics:
  \begin{eqnarray}
    ...
    && d\left(\frc{nG^{E}}{RT}\right) = \frc{nV^{E}}{RT}dP - \frc{nH^{E}}{RT^{2}}dT + \summation[\ln{\gamma_{i}}dn_{i}]{i}{};\;\;\; \overline{G}_{i}^{\text{E}}=RT\ln\gamma_{i}; \nonumber \\
    && \frc{V^{E}}{RT} = \Partial[\left(\frac{G^{E}}{RT}\right)]{P}{T,x};\;\;\; \frc{H^{E}}{RT} = -T\Partial[\left(\frac{G^{E}}{RT}\right)]{T}{P,x}; \nonumber \\
