...
%%% EXAMPLE 
%%%  
\item\label{Mod03Ex06} Steam (dry and saturated) is supplied by the boiler at 15 bar and the condenser pressure is 0.4 bar. Calculate the Rankine efficiency of the cycle. Neglect the pump work.

% SOLUTION  
    \noindent{\bf Solution:} At 15 bar, dry and saturated $\left(\ie x_{1}=1\right) steam has the following properties (from saturated table),
          \begin{eqnarray}
...
%%% EXAMPLE 
%%%  
\item\label{Mod03Ex06} The table below represents the steps of an idealised steam power plant:
    \begin{center}
     \begin{tabular}{||c | c | c | c | c | c ||}
      \hline\hline
