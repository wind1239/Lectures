...
\begin{subequations}
   ...
   For simplicity of the analysis, let's assume {\it single homogeneous (\ie one-phase system) chemical reaction}. The total Gibbs free energy of a system is obtained from
     \begin{equation}
         G^{t} = \summation[n_{i}G_{i}]{i=1}{\mathcal{C}} = \summation[\left(n_{i,0}+\nu_{i}\varepsilon\right)G_{i}]{i=1}{\mathcal{C}}\label{Mod6:Eqn:2a}
     \end{equation}
   where $G_{i}$ is the molar Gibbs free energy. At equilibrium (Fig.~\ref{Mod06Fig02}), $\left(dG^{t}\right)_{T,P} = 0$, \ie
      ...
      \begin{figure}[hpt]
         ...
         \end{center}
      \end{figure} 
   Differentiating Eqn.~\ref{Mod6:Eqn:2a} \wrt $\varepsilon$,
       \begin{eqnarray}
