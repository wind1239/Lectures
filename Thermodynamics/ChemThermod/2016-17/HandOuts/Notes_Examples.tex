...
In Fig.~\ref{Mod04Fig02}, a generic $P-T-xy$ diagram is shown. Vertical planes parallel to \blue{0-1-R-M-U-0} (\eg plane \blue{E-A-B-D-E}) indicates $P-xy$ diagrams at constant temperature, whereas horizontal planes parallel to \blue{K-J-I-H-K} indicates $T-xy$ diagrams at constant pressure. 



\eg, in the `lens' \blue{AB} at a vertical constant temperature plane, the lower part corresponds to $P-y_{1}$ (vapour) phase behaviour, and the upper part is the $P-x_{1}$ (liquid) phase behaviour. Overall, the solid (grey) projection in this figure represents the liquid and vapour phases in thermodynamic equilibrium at several constant temperatures, whereas the region below and above this solid represent the homogeneous vapour and liquid phases, respectively. 
      \begin{figure}[h]
         \begin{center}
         ...
         \end{center}
       \end{figure}
       The upper line (for each temperature level) of this solid is the saturated liquid line whilst the lower line is the saturated vapour line.
...
A similar generic diagram is shown in Fig.~\ref{Mod04Fig02}(bottom) with distinct vertical ($T$ constant) and horizontal ($P$ constant) planes within the solid (grey) projection. At the vertical The $x_{1},y_{1}$ axis is limited to zero and one, thus at $x_{1}$ (or $y_{1}$) equal to zero, $x_{2}$ (or $y_{2}$) is equal to unity, \ie pure component \blue{2} in solution. Similarly at $x_{1}$ (or $y_{1}$) equal to one, $x_{2}$ (or $y_{2}$) is equal to zero, \ie pure component \blue{1} in solution. The diagram also depicts points \blue{$C_{1}$} and \blue{$C_{2}$} along with the planes of $x_{1},y_{1}=0$ and $x_{1},y_{1}=1$, respectively, these two points are the coordinates of the critical points of both pure components. Critical coordinates for various mixtures of \blue{1} and \blue{2} lie along a line on the rounded edge of the surface between \blue{$C_{1}$} and \blue{$C_{2}$}.

The (subcooled) liquid region lies above the upper surface of the solid (grey) projection, and (superheated) vapour region lies below the under surface. The interior of the solid projection between the two surfaces is the
region of coexistence of both liquid and vapor phases.
