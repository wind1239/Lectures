    ...
    \begin{shaded}
       ...
       \begin{enumerate}[a)]
           \item At room pressure conditions, $P^{\circ}-P=0$ and
              ...
              \end{equation}
              Although this equation seems relatively simple to solve, activity coefficient models will need to be used, making it rather complex to solve it iteratively.
