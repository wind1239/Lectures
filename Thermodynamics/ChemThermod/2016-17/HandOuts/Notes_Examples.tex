...
%
     ...
     \begin{equation}
       \overline{U}_{i}^{\text{igm}}(T,y) = \Partial[U^{\text{igm}}(T,N)]{n_{i}}{T,P,n_{j\ne i}} = \left.\frc{\partial}{\partial n_{i}}\right|_{T,P,n_{j}}\summation[n_{j}\overline{U}_{j}^{\text{ig}}(T)]{j=1}{\mathcal{C}} = \overline{u}_{i}^{\text{ig}}(T)\label{Mod5_IGM3}
     \end{equation}
     This means that the partial molar internal energy of a species $i$ in an ideal gas mixture is the same of its molar internal energy. We can also obtain the {\it partial molar volume}, $\overline{V}_{i}^{\text{igm}}$, with the same conclusion,
     \begin{equation}
       \overline{V}_{i}^{\text{igm}}(T,P,y) = \Partial[V^{\text{igm}}(T,P,N)]{n_{i}}{T,P,n_{j\ne i}} = \left.\frc{\partial}{\partial n_{i}}\right|_{T,P,n_{j}}\summation[n_{j} \frc{RT}{P}]{j=1}{\mathcal{C}} = \frc{RT}{P} = \overline{v}_{i}^{\text{ig}}(T,P).\label{Mod5_IGM4}
     \end{equation}
     \medskip
     ...
     For entropy\footnote{Here we will use a entropy relation that has not been derived in this notes,
       \begin{displaymath}
