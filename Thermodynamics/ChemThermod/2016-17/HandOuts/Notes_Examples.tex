...
%%% EXAMPLE 
%%%  
\item\label{Mod03Ex06} Steam (dry and saturated) is supplied by the boiler at 15 bar and the condenser inlet pressure is 0.4 bar. Calculate the Rankine efficiency of the cycle. Neglect the pump work.
...
% SOLUTION  
    ...
    In the condenser, $P_{2}=0.4$ bar,
          \begin{eqnarray}
              ...
              h_{\text{g}} &=& 2636.8\;\text{kJ.kg}^{-1},\;\;\; h_{\text{f}} = 317.58\;\text{kJ.kg}^{-1},  \nonumber \\
              s_{\text{g}} &=& 7.6700 \;\text{kJ.(kg.K)}^{-1},\;\;\; s_{\text{f}} = 1.0259\;\text{kJ.(kg.K)}^{-1}. \nonumber  
          \end{eqnarray}
$h_{2}$ and $s_{2}$ depend on the knowledge of how vaporised the water is, in other words, we need to determine the quality of the steam, $x_{1}$ 
