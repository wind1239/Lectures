...
There are two main conditions for a system to achieve {\it chemical equilibrium}:
  ...
  \begin{subequations}
    ...
    \medskip
    However, if $S$, $V$ and $n$ are set as constants, then from Eqn.~\ref{Mod04_EquilibriumCriteria1}, the system will be stable if \underline{$dU>0$}, \ie \underline{$U$ is minimum}.
