...
%%% SECTION
%%%
   \subsection{Work for Compressible Fluids}\label{Chapter:FirstLaw:Section:WorkCompressibleFluids}
   ...
   \begin{displaymath}
     W_{12}^{A} > W_{12}^{B},
   \end{displaymath}
   as the work depends on the path selected, and not only on the initial and final coordinates. Several real thermodynamics processes are often described by {\it polytropic processes}\index{Process!Polytropic} in which,
   \begin{equation}
