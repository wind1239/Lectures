...
%%% SECTION
%%%
     \subsection{Exact and Inexact Differentials}\label{Chapter:FirstLaw:Section:ExactInexactDiff}\index{Exact differential}
     %\begin{subequations}
...
%%% SECTION
%%%
     \subsection{Enthalpy}\label{Chapter:FirstLaw:Section:Enthalpy}\index{Enthalpy}
        \begin{subequations}
          ...
          \begin{shaded}
             ...
             \begin{eqnarray}
                \delta Q &=& dU - \delta W = U_{2} - U_{1} + P_{2}V_{2} - P_{1}V_{1}\nonumber \\
                         &=& \left(U_{2}-P_{2}V_{2}\right) - \left(U_{1}-P_{1}V_{1}\right)
             \end{eqnarray}
          \end{shaded}
...
%%% SECTION
%%%
     \subsection{Heat Capacity}\label{Chapter:FirstLaw:Section:HeatCapacity}\index{Heat Capacity ! Constant Volume}\index{$C_{v}$| see{ Heat Capacity}}
