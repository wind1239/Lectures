   ...
   \begin{MyExample}{\begin{center}{\bf Example}\end{center}}
     \begin{example}\label{Chapter:FirstLaw:Example2}\citep{Rajput_Book}
       ...
       \begin{displaymath}
         PV = 3,
       \end{displaymath}
       where [$P$] and [$V$] are in bar and m$^{3}$, respectively. Calculate the work done during the compression.
       {\it For a reversible compression from $P_{1}$ = 1.5 to $P_{2}$ = 7.5 bar to happen, work needs to be given to the system and can be calculated from}
         ...
         \end{displaymath}
       {\it As the gas behaves according to the relation,} $V=\frac{3}{P}$, {\it we can readily conclude that initial and final volumes as 2 and 0.4 m$^{3}$, respectively. Now, integrating from $V_{1}$ to $V_{2}$ and replacing $P$ with $\frac{3}{V},} 
         \begin{displaymath}
           W_{\text{rev}} = -\int\limits_{V_{1}}^{V_{2}}PdV = - \int\limits_{V_{1}}^{V_{2}} \frc{3}{V}dV = -3\int\limits_{V_{1}}^{V_{2}} \frc{dV}{V} = -3 \ln{\frc}V_{2}{V_{1}} = 4.8283\text{bar.m}^{3}
         \end{displaymath}
