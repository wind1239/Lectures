...
\chapter{Summary of Logarithms and Exponential Properties}\label{Chapter:LogExpReview}
...
%%% EXPONENTS
%%%
\section{Exponents}\label{Chapter:LogExpReview:Section:Exp}
...
%%% LOGARITHMS
%%%
\section{Logarithms}\label{Chapter:LogExpReview:Section:Log}
