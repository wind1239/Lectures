\documentclass[11pts,a4paper,amsmath,amssymb,floatfix]{book}%{article}%{report}%{book}
...
\vspace{3.5cm}
   ...
   {\bf{\Huge EX3029: Chemical Thermodynamics }}
...
\input{Module_01} % Introduction and Review of Thermodynamics
\input{Module_02} % Volumetric Properties of Pure Fluids
\pagebreak
