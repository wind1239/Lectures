...
%%% SUBSECTION
\section{Introduction}\label{Chapter:SolutionThermodynamics:Introduction}
...
%%% SECTION
\section{Fugacity}\label{Chapter:SolutionThermodynamics:FugacitySection}
\begin{subequations}
...
%%% SECTION
\section{Activity and Activity Coefficient }\label{Chapter:SolutionThermodynamics:ActivitySection}
   \begin{subequations}
...
%%% SECTION
\section{Henry's Law}\label{Chapter:SolutionThermodynamics:HenryLaw}
 %
...
%%% SECTION
\section{Gibbs-Duhem Equation}\label{ChapterChapter:SolutionThermodynamics:Section:GibbsDuhem}
   \begin{subequations}
%
...
\section{Fugacity Coefficient of Species in Mixtures}\label{Chapter:SolutionThermodynamics:FugacityCoefficient}
   \begin{subequations}
%
      In  Section~\ref{Chapter:SolutionThermodynamics:FugacitySection} (Eqn.~\ref{Mod05_fugacity1b}), a formal definition of fugacity was introduced,
       \begin{displaymath}
          \mu_{i}= RT\ln{\overline{f}_{i}} + C_{i}(T),
       \end{displaymath}
...
%%% SECTION
\section{Ideal Solution Model}\label{Chapter:SolutionThermodynamics:IdealSolution}
%
   \begin{subequations}
%
