...
%%% SECTION
\section{Ideal Solution Model}\label{Chapter:SolutionThermodynamics:Section:IdealSolution}\index{Solution!Ideal}\index{Gibbs free energy!ideal solution}\index{Helmholtz free energy!ideal solution}\index{Enthalpy!ideal solution}\index{Entropy!ideal solution}\index{Internal Energy!ideal solution}
%
   \begin{subequations}
%
