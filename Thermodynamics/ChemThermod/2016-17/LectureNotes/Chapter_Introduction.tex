...
%%% SECTION
%%%
   \section{Thermodynamic Work}\label{Chapter:Introduction:Section:ThermodynamicWork}\index{Work}
   \begin{subequations}
     ...
     \end{equation}
     Equation~\ref{Chpt01_Work2} describes the work undertaken by any process where volume changes due to transfer of energy from or to the system. If the fluid undertakes a compression (thus reduction of volume) due pressure over the system, the work is positive, otherwise when the system performs work (\ie transfer energy to the surroundings through expansion of the boundaries), the work is negative.
