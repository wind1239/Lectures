...
\subtitle{Module 1: Volumetric Properties of Pure Substances}
\date[ ]{ }
...
\begin{frame}
 \frametitle{Learning Objectives}
   \begin{enumerate}
     \item<1-> Define pure substances and thermodynamic phases;
     \item<1-> State the Gibbs phase rule and its use to define the number of degrees of freedom of a system;
     \item<1-> Identify phases and phase transitions in a diagram;
     \item<1-> Formulate the solution for thermodynamic problems involving the calculation of volume of pure substances;
     \item<1-> Select appropriate equation of state for a given problem/application;
   \end{enumerate}
...
\begin{frame}
 \frametitle{Suggested References}
  ...
  \begin{enumerate}[1.]
   \item \blue{Chapter 5 of Lecture Notes};
   \item J.M. Smith, H.C. Van Ness, M.M. Abbott, $\lq$Introduction to Chemical Engineering Thermodynamics', 6$^{th}$ Edition: Chapter 3;
   \item S.I. Sandler, 'Chemical, Biochemical and Engineering Thermodynamics', 6$^{th}$ Edition: Chapter 6;
...
%%% SUBSECTION
%%%
\subsection{EOS expressed as a Functional}
...
\begin{frame}
 \frametitle{Ideal Gas}
    \begin{enumerate}%\scriptsize
       \item<1-> Assumptions:
          \begin{enumerate}[a)]
             \item<1-> molecules of gases are considered as {\bf massless} particles;
             \item<1-> there are {\bf no} interaction between the gas particles as
               \begin{itemize}
                 \item<1-> volume of the molecules is negligibly small compared with the volume occupied by the gas, and/or;
                 \item<1-> the distance between gaseous molecules are infinitely large, except during elastic collisions over negligible duration.
               \end{itemize}
          \end{enumerate}
        \item<2-> For a gas to behave as an ideal gas: $\blue{P \rightarrow 0}$. \\
            \visible<3->{In practical terms, a gas is assumed to behave as an ideal gas at low to moderate pressures;}
        \item<4-> Ideal Gas EOS:
            \visible<4->{\begin{equation}\label{Mod1:IdealEoS}
                 PV = nRT,
              \end{equation} where}
...
%\scriptsize
\begin{frame}
  \frametitle{Universal Gas Constant}
...
\begin{frame}
 \frametitle{Generic Cubic EOS}
    \begin{enumerate}\scriptsize
      ...
      \item<3-> \blue{General format} of a cubic equation on $V$,
...
\begin{frame}
 \frametitle{Cubic Equations of State}
    ...
    \visible<2->{\begin{block}{Redlich-Kwong}
        \begin{equation}\label{Mod3:vdWEOS}
              P = \frc{RT}{V-b} - \frc{a}{\sqrt{T}\left(V + b\right)V}
        \end{equation}
       with $a = 0.42748\frc{R^{2}T_{c}^{2.5}}{P_{c}}$ and $b=0.08664\frc{R T_{c}}{P_{c}}$.
    \end{block}}    
...
\begin{frame}
 \frametitle{Cubic Equations of State}
    \visible<1->{\begin{block}{Soave-Redlich-Kwong}
        ...
        \end{equation}
        with $\alpha = \left[1+\kappa\left(1-\sqrt{T_{r}}\right)\right]^{2}$ and $\kappa=0.480+1.574\omega-0.176\omega^{2}$, where $T_{r}=\frc{T}{T_{c}}$.
    \end{block}}    
    ...
    \visible<2->{\begin{block}{Peng-Robinson}
        ...
        \end{equation}
       with  $\kappa=0.37464+1.54226\omega-0.26992\omega^{2}$, $a=0.45724\frc{R^{2}T_{c}^{2}}{P_{c}}$ and $b=0.07780\frc{R T_{c}}{P_{c}}$
    \end{block}}    
...
\begin{frame}
  \frametitle{Cubic Equations of State}
    \begin{center}
      {\bf Numerical Solution of the Generic Format of Cubic Equations of State (Eqns.~\ref{Mod3:GenCubicEqn}-\ref{Mod3:GenCubicEOS})}
    \end{center}
...
\begin{frame}
 \frametitle{Tutorial}
   \bigskip
   \begin{block}{}
        \begin{center}List of problems at Chapter 5 from the Lecture Notes.\end{center}
   \end{block}
