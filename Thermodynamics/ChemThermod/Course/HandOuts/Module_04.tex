...
\begin{frame}
  \frametitle{Fugacity: Definition for Pure Fluids}
        \begin{enumerate}\setcounter{enumi}{8}  
           \item<1-> \red{Fugacity} has the same units of pressure and is often referred as {\it fictitious pressure}.
  ...
  \frametitle{Fugacity: Lewis-Randall Rule for Mixtures}
        \begin{enumerate}\setcounter{enumi}{4}  
           ...
           \item<1-> (Cont.) resulting in 
              ...
              \end{displaymath}
              leading to,
                 \visible<2->{\begin{block}{\begin{center}\normalsize{ Relationship between Fugacity of a Pure Component and a Component in the Mixture}\end{center}}
                       \begin{displaymath}
...
%%% SECTION
%%%
\section{Ideal Solutions and the Activity Coefficient}
...
\begin{frame}
  \frametitle{Ideal Solutions}
        \begin{enumerate}%\setcounter{enumi}{3}  
           ...
           \item<2-> Now, we should extend this definition to \real{ideal liquid solutions} (or \red{ideal liquid mixtures}), thus
             \begin{enumerate}[a)]
                \item<3-> Chemical species have similar molecular size and structure;
                \item<4-> Obey Raoult's law (and the Raoult's law for fugacity) over the entire range of {\bf conposition};
                ...
                \item<5-> $\Delta V_{\text{mix}}=0$, \ie total volume of the solution is equal to the sum of the molar volumes of all components;
                \item<6-> Total pressure is the sum of all partial pressures (\ie Dalton's law is obeyed),
                  \begin{displaymath}
                    P = \summation[P_{i}]{i}{} = \summation[P_{i}^{\text{sat}}x_{i}]{i}{}
                  \end{displaymath}
             \end{enumerate}  
        \end{enumerate}
\end{frame}
...
\begin{frame}
  \frametitle{Activity Coefficient}
        \begin{enumerate}%\setcounter{enumi}{2}  
           \item<1-> Since the chemical potential was defined as the molar Gibbs free energy, \ie $\mu_{i}^{\circ} = \overline{g}_{i}^{\circ}$, therefore
              \begin{displaymath}
       ...
       \begin{block}{\begin{center}\normalsize{ Activity Coefficient}\end{center}}
            \begin{enumerate}\setcounter{enumi}{1}  
               ...
               \item<2-> For VLE at low pressures:
                  \begin{eqnarray}
                      \blue{\gamma_{i}} &=& \frc{\overline{f}_{i}}{x_{i}f_{i}} = \frc{y_{i}P}{x_{i}f_{i}} \nonumber \\
                                        &=&  \blue{\frc{y_{i}P}{x_{i}P_{i}^{\text{sat}}}}, \nonumber
                  \end{eqnarray}
                  this expression is the \red{modified Raoult's law}.
             \end{enumerate}
        \end{block}
