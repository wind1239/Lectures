  ...
  \frametitle{Fugacity: Definition for Pure Fluids}
        \begin{enumerate}\setcounter{enumi}{6}  
           ...
           \item<2-> Therefore, the previous expression can also be used to represent the \red{chemical potential of real fluids},
             ...
             \visible<2->{\begin{block}{\begin{center}\normalsize{ Fugacity of Real Fluids}\end{center}}
                 \begin{displaymath}
                   \blue{\mu = RT\ln{f} + C(T).}
                 \end{displaymath}
                 The \red{fugacity of a real gas (f)} is a mathematical representation of pressure of an ideal gas that has the \red{same chemical potential as the real gas},
                    \begin{displaymath}
                        \begin{cases}
                            \mu^{\text{ig}} = RT \ln{P} + C(T), & \\
                            \mu = RT \ln{f} + C(T). & 
...
\begin{frame}
  \frametitle{Fugacity: Lewis-Randall Rule for Mixtures}
        \begin{enumerate}\setcounter{enumi}{5}  
           \item<1-> Assuming \blue{an ideal mixture}, the partial pressure of species $i$ is the fugacity of component $i$ in the mixture, \ie
                 \begin{displaymath}
