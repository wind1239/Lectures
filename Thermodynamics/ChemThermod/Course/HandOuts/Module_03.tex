...
\begin{frame}
  ...
  \begin{enumerate}[i)]
    ...
    \item<3-> \blue{Molality} of a solution: number of moles of solute in 1 kg of solvent,
         \visible<3->{\begin{displaymath}
...
\begin{frame}
  ...
  \begin{enumerate}[i)]
     \item<1-> In Module 2 \blue{\it residual properties} were defined as the difference between any extensive thermodynamic property, $M$, in real gases and its equivalent assuming ideal gas behaviour, $M^{\text{ig}}$ -- this entity is only applied to gases;
