...
\begin{frame}
 \frametitle{Aims and Objectives}
   \begin{enumerate}
     ...
     \item<1-> In Modules 3 and 4 we focused on systems involving mixtures of components in gas and liquid phases behaving as ideal and non-ideal solutions;
...
%\scriptsize
\begin{frame}
  \frametitle{Chemical Reaction Process: \underline{Diffusion} $\times$ Kinetics $\times$ Thermodynamics}
...
%\scriptsize
\begin{frame}
  \frametitle{Chemical Reaction Process: Diffusion $\times$ \underline{Kinetics} $\times$ Thermodynamics}
...
%\scriptsize
\begin{frame}
  \frametitle{Chemical Reaction Process: \underline{Diffusion} $\times$ \underline{Kinetics} $\times$ Thermodynamics}
...
\begin{frame}
  ...
  \begin{enumerate}
    \item<1-> Change in quantities as reaction progresses:
        ...
        \end{displaymath}}
    \item<1-> \red{Reaction coordinate $\varepsilon$},
  ...
  \frametitle{Standard Enthalpy of Reaction}
      Given the homogeneous reaction:
        \begin{displaymath}
         ...
         \end{displaymath} 
      \begin{enumerate}[a)]
         \item<2-> The \red{standard enthalpy of reaction, $\Delta H_{r}^{\circ}$} (also called {\it standard heat of reaction}) is the heat produced or consumed during a chemical reaction at constant $T$ and \blue{\it standard pressure of 1 atm} 
      \end{enumerate}
\end{frame}
\normalsize
