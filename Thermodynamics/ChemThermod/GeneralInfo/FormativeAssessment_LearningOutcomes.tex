...
%%%
%%% Headers and Footers
\lhead[] {\text{\small{Learning Outcomes }}} 
\rhead[] {{\text{\small{Chem. Thermodynamics (EX3029)}}}}
...
\begin{document}
\begin{center}
{\huge Formative Assessment: Solution Thermodynamics and Vapour-Liquid Equilibrium of Mixtures}
\end{center}

\section{Modules's Syllabus relevant for this Assessment}
    \begin{itemize}
        \item Vapour pressure and the Antoine Equation are treated allowing two-component in vapour-liquid equilibrium to be discussed in terms of Raoult's law and modified Raoult's law;
        \item PVT relations for real gas mixtures; 
        \item Dalton's $\&$ Amagat's laws modified by compressibility;
        \item Solution thermodynamics concepts including fugacity and excess properties are introduced. Activity models are discussed.
    \end{itemize}

%%%
%%% Section
%%%
\section{Learning Outcomes of this Assessment}
...
%%% Section
%%%
\section{Recommended Textbooks for this Assessment}
\begin{enumerate}[1.]
