...
\rhead[] {{\text{\small{Lab Exercise 1: EOS using Matlab }}}}
...
{\bf Problem:}\\
 {\it Fluid X} is injected into a cell with final specific volume of 1.0 litres.gmol$^{-1}$. The cell was designed to investigate the PVT behaviour of gases and can be heated up to 800 K with system monitoring for internal pressure and temperature. The cell was heated from 400 to 600 K and the pressure changed as shown in Table \ref{Practical1:Table1},
