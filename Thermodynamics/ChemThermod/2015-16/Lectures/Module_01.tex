...
\begin{frame}
 \frametitle{The Thermodynamic System}
  ...
  \end{enumerate}
  \visible<6->{\begin{block}{\begin{center}\scriptsize Thermodynamics {\bf does}:\end{center}}
     ...
     \end{enumerate} 
  \end{block}  }
  \visible<7->{\begin{block}{\begin{center}\scriptsize Thermodynamics {\bf does not}:\end{center}}
     \begin{enumerate}[(a)]\scriptsize
...
\begin{frame}
 \frametitle{General Remarks}
  ...
  \begin{center}
    \visible<2->{\begin{tabular}{c c c | c c c}
      \hline
