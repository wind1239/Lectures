 ...
 \begin{columns}
  \begin{column}[c]{0.5\linewidth}
   \begin{enumerate}[(1)]\setcounter{enumi}{4} \scriptsize
     ...
     \begin{enumerate}[(a)] \scriptsize
        \item<3-> \blue{Spark-Ignition (SI) Engines:} the combustion of the air–-fuel mixture is initiated by a spark plug (the mixture is at  \red{flash point} conditions);
        \item<4-> \blue{Compression-Ignition (CI) Engines:} the air–-fuel mixture is self-ignited as a result of compressing the mixture above its self-ignition temperature.
     \end{enumerate}
   \end{enumerate}
  \end{column}
  \begin{column}[c]{0.5\linewidth}
