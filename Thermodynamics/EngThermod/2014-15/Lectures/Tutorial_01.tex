...
\hline
 160.0          &    720.65 K        &     (a)             &     (b)                     &   (c)         \\
  38.2          &     --             &     (d)             &     (e)                     &   liquid water \\
 140.0          &    440.00$^{\circ}$C&     (f)             &     (g)                     &   (h)         \\  
\hline\hline
\end{tabular}
\end{center} 
...
%%%
%%%
\item\label{Tut01:FirstLawIdealGas1} Given Argon ({\it Ar}) at P$_{1}$ = 140 kPa, T$_{1}$ = 10$^{o}$C, V$_{1}$ = 200 liters which undergoes a polytropic compression to P$_{2}$ = 700 kPa, T$_{2}$ = 180 $^{o}$C, find Q$_{1-2}$. Given the molar mass, MW = 39.948 kg.mol$^{-1}$ and the heat capacity at constant volume, C$_{V}$ = 0.312 kJ.kg$^{-1}$.K$^{-1}$.
