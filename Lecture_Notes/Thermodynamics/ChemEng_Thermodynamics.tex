...
%%%%%%%  ENVIRONMENTAL VARIABLES FOR Tutorial Problem Solutions   %%%%%%%%%%
\newcounter{probsolcounter}
\newenvironment{probsol}{\begin{quote}%
    \refstepcounter{probsolcounter}%
  \textbf{Problem \arabic{probsolcounter}}%
  \quad
}{%
\end{quote}%
}
...
\extraPartText{\blue{(Contents of this Part are not examinable. They were designed to help with notations and definitions used in the remaining of this Notes.)}}
\part{Introduction and Review of Basic Concepts}
  \input{Chapter_Introduction} % Introduction and Review of Basic Concepts of Thermodynamics
     \setcounter{examplecounter}{0}
  \input{Chapter_PropertyGases} % Introduction to gas properties
     \setcounter{examplecounter}{0}
  \input{Chapter_FirstLaw} % Introduction to First Law of Thermodynamics
     \setcounter{examplecounter}{0}
  \input{Chapter_SecondLaw} % Introduction to Second Law of Thermodynamics

\part{Thermodynamic Properties of Fluids}  
     \setcounter{examplecounter}{0} 
     \setcounter{problemcounter}{0}
  \input{Chapter_VolumetricPropertiesPureFluids} % Volumetric Properties of Pure Substances
     \setcounter{examplecounter}{0}
     \setcounter{problemcounter}{0}
  \input{Chapter_ThermodynamicPropertiesPureFluids} % Thermodynamic Properties of Pure Fluids

\part{Phase Equilibria}
     \setcounter{examplecounter}{0}
     \setcounter{problemcounter}{0}
  \input{Chapter_VapourLiquidEquilibrium} % VLE
     \setcounter{examplecounter}{0}
     \setcounter{problemcounter}{0}
  \input{Chapter_SolutionThermodynamics} % Solution Thermodynamics

\part{Introduction to Chemical Reactions Thermodynamics}
     \setcounter{examplecounter}{0}
     \setcounter{problemcounter}{0}
  \input{Chapter_ChemicalReactionEquilibrium} % Reaction Chemistry
  ...
  \begin{appendix}
     \part{Appendices} 
       ...
       \input{Appendix_ConversionTable}
         \setcounter{examplecounter}{0}
       \input{Appendix_ListOfEquations}
         \setcounter{examplecounter}{0}
       ...
       \input{Appendix_SaturatedTables}
         \setcounter{examplecounter}{0} 
       \input{Appendix_SolutionsProblems}
