...
%
  \begin{problem}\label{Chapter:VLE:Problem:01}\citep{Sandler_Book} % Jeff Solved Example 1 ==> Sandler Example 10.1.1 (page 498)
  ...
  \end{problem}
%
  \begin{problem}\label{Chapter:VLE:Problem:02}\citep{Sandler_Book} % Jeff Solved Example 2 ==> Sandler Example 10.1.2 (page 501)
    \begin{enumerate}[a)]
  ...
  \end{problem}
%
  \begin{problem}\label{Chapter:VLE:Problem:03}\citep{Sandler_Book} % Jeff Solved Example 3 ==> Sandler Example 10.1.4 (page 504)
  ...
  \end{problem}
%
  \begin{problem}\label{Chapter:VLE:Problem:04} % Johannes Problem 1 (Tutorial 5)
  ...
  \end{problem}
%
  \begin{problem}\label{Chapter:VLE:Problem:05} % Johannes Problem 2 (Tutorial 5)
  ...
  \end{problem}
%
  \begin{problem}\label{Chapter:VLE:Problem:06} % Johannes Problem 4 (Tutorial 5)
  ...
  \end{problem}
%
  \begin{problem}\label{Chapter:VLE:Problem:07}\citep{SmithVanNess_Book} % SM&VN 10.20 (pg 350)
