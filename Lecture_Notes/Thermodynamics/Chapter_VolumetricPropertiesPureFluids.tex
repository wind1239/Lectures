...
%%%
   ...
   \begin{LearningObjectivesBlock}{\begin{center}Solving Cubic Polynomial in Eqn.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1}\end{center}}

       You may have noticed that Eqns.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1_Zvap} and \ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1_Zliq} are non-linear equations, \ie terms $Z_{\text{vap}}$ and $Z_{text{liq}}$ appear in both sides of the equation, and as such they can not be readly solved. Numerical methods for solving these equations are described in Appendix~\ref{Section:RootFinderMethods}. Examples of how to apply these methods can be found in Example 5.\ref{Chapter:VolumetricPropertiesPureSubstances:Example3}. Alternatively, you may want to use your \red{{\bf Casio FX 991ES calculator}}
