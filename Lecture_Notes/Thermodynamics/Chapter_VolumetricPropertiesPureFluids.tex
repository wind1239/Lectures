...
%
  ...
  \begin{subequations}
       \citet{Peng_1985} proposed modifications into the SRK EOS to improve the prediction of liquid molar volumes, vapour pressure and volumetric behaviour of pure substances and binary mixtures. The Peng-Robinson EOS (PR EOS) is by far the most used EOS in current computational simulators,
        \begin{equation}
