...
%%%
     ...
     \end{enumerate}
     In \citet{Atkinson_Book_Newton}, you may find several analytical and numerical methods to calculate roots of polynomials of any degree. The relevant roots for tyhe cubic polynomial, Eqn.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1}, can be obtained from the following relations:
     \begin{shaded}
        \begin{eqnarray}
