 ...
 \begin{subequations}
     The Virial EOS was introduced by H. Kamerlingh-Omnes in 1901 to describe gas compressibily coefficient, $Z$, as a power series  in terms of $\frc{1}{V}$ for a pure gas, with two alternate forms:
       ...
       A number of {\it generalised relations} have been developed to calculate the {\it second virial coefficients}, \eg
        ...
        \begin{equation}
           B^{0} = 0.083 - \frc{0.422}{T_{r}^{1.6}}\;\;\text{ and }\;\; B^{1} = 0.139 - \frc{0.172}{T_{r}^{4.2}}.\label{Chapter:VolumetricPropertiesPureSubstances:Eqn:Virial4}
        \end{equation}
...
%
  ...
  \begin{subequations}
       \citet{Peng_1985} proposed modifications into the SRK EOS to improve the prediction of liquid molar volumes, vapour pressure and volumetric behaviour of pure substances and binary mixtures. The Peng-Robinson EOS (PR EOS),
        ...
        with,
        \begin{eqnarray}
           && a = \frc{0.45724\; R^{2}T_{c}^{2}}{P_{c}},\;\;\;b = \frc{0.07780\; R T_{c} }{P_{c}}\;\;\;\;\text{ and } \nonumber \\
...
\end{table}
%%%
     \noindent Coefficients for these expressions are listed in Table~\ref{Chapter:VolumetricPropertiesPureSubstances:Table:GeneralCubicEOS1}. Equation~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1} has three roots,
     \begin{displaymath}
       \left\{Z_{1}, Z_{2} \text{ and } Z_{3}\right\},
     \end{displaymath}
     in which
     \begin{enumerate}[a)]
         \item the \underline{largest real positive root} represents the {\it vapour phase}, $Z_{\text{vap}}$;
         \item the \underline{smallest real positive root} represents the {\it liquid phase}, $Z_{\text{liq}}$;
         \item the intermediate root has no physical meaning. 
     \end{enumerate}
     In \citet{Atkinson_Book_Newton}, you may find several analytical and numerical methods to calculate roots of polynomials of any degree. Relevant roots for the cubic polynomial in Eqn.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1} can be obtained from the following relations:
     \begin{shaded}
        \begin{eqnarray}
   ...
   \begin{LearningObjectivesBlock}{\begin{center}Solving the Cubic Polynomial in Eqn.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1}\end{center}}

       You may have noticed that Eqns.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1_Zvap} and \ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1_Zliq} are non-linear equations, \ie terms $Z_{\text{vap}}$ and $Z_{text{liq}}$ appear in both sides of the equation, and as such they can not be readly solved. Numerical methods for solving these equations are described in Appendix~\ref{Section:RootFinderMethods}. Examples of how to apply these methods can be found in Example 5.\ref{Chapter:VolumetricPropertiesPureSubstances:Example3}. Alternatively, you may want to use the {\it SOLVE} function of your \red{Casio FX 991ES calculator}. More information may be found in:
      \begin{center}
            \href{http://support.casio.com/pdf/004/fx-115ES_991ES_Eng.pdf}{http://support.casio.com/pdf/004/fx-115ES$\_$991ES$\_$Eng.pdf}, \\
             \href{https://www.youtube.com/watch?v=DDVkBMGmVy8}{https://www.youtube.com/watch?v=DDVkBMGmVy8} and \\
             \href{https://www.thestudentroom.co.uk/revision/mathematics/making-the-most-of-your-casio-fx-991es-calculator}{https://www.thestudentroom.co.uk/revision/mathematics/making-the-most-of-your-casio-fx-991es-calculator}.
      \end{center}
...
%
               \item From Eqns.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:Virial2b} and \ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:RealEOS_Z},
                  ...
                  \end{displaymath}
                  manipulating this equation with Eqns.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:Virial3} and~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:Virial4} ,
                  \begin{displaymath}
...
%
  \begin{problem}\label{Chapter:VolumetricPropertiesPureSubstances:Problem:01} % Johannes T4Q2
     Calculate $V$ and $Z$ for gaseous sulphur hexafluoride at 75$^{\circ}$C and 15 bar by the following equations of state:
        \begin{enumerate}
