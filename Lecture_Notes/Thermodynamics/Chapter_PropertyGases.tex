...
%%%
   ...
   \begin{subequations}
     ...
     \begin{equation}
        y_{i} = \frc{n_{i}}{n},\;\;\;\text{ with }\;\;i=1,\cdots,\mathcal{N}.\label{Chapter:Intro_Property_of_Gases:Eqn:MolFraction}
     \end{equation}
