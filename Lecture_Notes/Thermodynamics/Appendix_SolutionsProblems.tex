        ...
        \item Redlich-Kwong EOS:
            ...
            \begin{enumerate}[a)]
               ...
               \item Calculating $Z^{\text{vap}}$ through Eqn.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1_Zvap} and then obtain $V^{\text{vap}}$: the general form of the cubic EOS (Eqn.~\ref{Chapter:VolumetricPropertiesPureSubstances:Eqn:GeneralCubicEOS1_Zvap}) can be used to calculate $Z^{\text{vap}}$ and then calculate $V^{\text{vap}}$, 
                   ...
                   \begin{displaymath}
                      Z^{\text{vap}} = 0.8883 \;\;\;\Longrightarrow \;\;\; V^{\text{vap}} = \frc{Z^{\text{vap}} R T}{P} = 1714.1342 \text{cm}^{3}\text{.mol}^{-1}
                   \end{displaymath}
            \end{enumerate}
%
        \item Soave-Redlich-Kwong EOS: using the same procedure as in (b) above with 
                   ...
                   \begin{displaymath}
                      Z^{\text{vap}} = 0.8949 \;\;\;\Longrightarrow \;\;\; V^{\text{vap}} = \frc{Z^{\text{vap}} R T}{P} = 1726.8701 \text{cm}^{3}\text{.mol}^{-1}
                   \end{displaymath}
%
