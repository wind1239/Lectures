...
=======
  {\Large Review of the Manuscript `Waves Propagation and Run-Up by Tsunami: Earthquake of 1979 in Colombian Pacific' by M.A.Y. Lobon}
\end{center}

\medskip
The manuscript aims to investigate tsunami models embedded within GeoClaw and STAV2D software to assess waves propagation in the Colombian Pacific coast during the 1979's tsunami. The topic of the manuscript is interesting and the overall approach is quite insightful, although aims, objectives and (mainly) novelties are not clearly outlined. The paper is relatively well written but with a large number of typos and unrevised sentences. Several sentences are confusing and disconnected with no clear objectives (see annotated copy in attachment). However, the manuscript is insightful despite a limited overview of the main subject areas: shallow-water equations, Riemman problem, high-resolution methods, physics of tsunamis etc.

The main aim of the manuscript is to '(...) develop a case study of the tsunami model on the Pacific Ocean generated by earthquake of 1979 with special interest in its effects over the municipality of Tumaco (...)'. Indeed, from the title (and from the aim stated in the Introduction) I was expecting (a) a comprehensive overview of computational models currently used to simulate tsunamis wave propagation (\eg  Mitchell et al.(2010) Sedimentary Geology 228:81-97; Oishi et al. (2013) J. Geophysical Research 118:2998-3018; Madison et al. (2011) Ocean Model 39:248-261; Nicolsky et al. (2011) Pure and Applied Geophysics 168:1199-1222); (b) literature review of non-linear shallow-water theory (main model approach used in this manuscript) and associated solution methods; (c) comprehensive review of model quality assurance (\ie validation) used by the community to assess accuracy of proposed models, and; (d) in-depth discussion of the outcomes of the chosen models (GeoClaw and STAV2D). Unfortunately, none of them was fully achieved in this manuscript, although (c) were partially covered. However, the main issue on this manuscript is the lack of a clear aim and objective of the work. In addition, the manuscript fails to clearly state the novelty of the work. A few comments:
\begin{enumerate}[(a)] 
%
    \item Abstract is missing;
    \item Meaninig of several used symbols are missing (see annotated copy in attachment);
    \item It is not really clear how the methods within GeoClaw and STAV2D differ;
    \item What is the impact of AMR on capturing detailed dynamics during wave propagation? What is the maximum and minimum mesh resolution used during the simulations;
    \item Methods (GeoClaw and STAV2D) in pages 12-13 were not really explained.
    \item I guess, one of the objectives of using STAV2D was to investigate sediment transport (page 13), however no explanation is given about the impact of the tsunami on the bathymetry sediment deposition after the Tsunami (Fig. 8).
      %
\end{enumerate}

In summary, the subject of the manuscript is interesting, however the paper still needs to be considerably improved before being considered for publication. The case-study is insightful but the novelty of the manuscript must be highlighted.




 In the attached scanned copy:
\begin{itemize}
  \item {\bf PE:} Poor English;
  \item {\bf SC:} Sentence(s) is/are very confusing.
\end{itemize}
>>>>>>> 6ca9095624e79f03b6cf73e94af613e9605cd0fd
...
=======
  \includepdf[pages=-,fitpaper, angle=0]{./Scan/Scan_MathDisasters_2018.pdf}} 
>>>>>>> 6ca9095624e79f03b6cf73e94af613e9605cd0fd
