...
\noindent{\bfseries\large EG3521 -- Engineering Thermodynamics (Continuous Assessment)  \hfill March, 2015}

\bigskip

\begin{center}
  {\Large Comments on the {\it Continuous Assessment Report} -- Group 05}
\end{center}

The paper investigates phase diagrams for refrigerant mixtures. The report summarised the paper and linked with learning outcome from the course. The paper is relatively well-written with a number of typos and unrevised sentences. Several sentences are confusing and disconnected with no clear objectives and inter-connectivities. A few comments,
\begin{enumerate}
%
...
\begin{center}
  {\Large Comments on the {\it Continuous Assessment Oral Presentation} -- Group 05}
\end{center}
\begin{enumerate}
%
...
* Graphics used appropriately to illustrate technical concepts to a general audience. Well done!

* Slides were clear and fit for purpose with a good level of technical content which is well described, although note that font size of heading should NOT be smaller than that of main text.

* Be more enthusiastic, try to burst with enthusiasm, if you are not, your audience will not be enthusiastic to listen to you.
