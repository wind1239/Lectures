...
%
\item Some symbols were used (in figures) without prior definition.
%
\item Analysis of numerical results were strongly based on theoretical concepts and reasoning. 
%
