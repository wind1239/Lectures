...
%
\item Equation 1.2 does not seem to correct, last term should be $\Delta p$, rather than $\partial p$. The later should refer to a partial differential equation, and the former to a algebraic equation.
%
...
\item[Examiner 2] Comments
   \begin{description}
      ...
      \item[Technical Contents and Merit of Thesis:'] `Technical communication quite unclear at times. Lots of parameters introduced, concepts introduced, equations derived without appropriate technical discussion. Odd not to see more evidence if chemical engineering fundamentals.'
      \item[Evidence of Critical Reasoning:] `Discussion is good but doesn't clearly demonstrate command of necessary chemical engineering fundamentals (thermo, phase behaviour, fluids etc).'
