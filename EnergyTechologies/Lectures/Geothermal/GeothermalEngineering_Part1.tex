...
\noindent
\begin{itemize}
\item <2-> Most of the problems in this module involves extracting values from the steam and refrigerant tables;
...
\begin{tabular}{ l c l }
$\Delta P=P_{2}-P_{1}=0.5$bar & $\longleftrightarrow$ & $\Delta H=H_{2}-H_{1}=-2.20\frac{kJ}{kg}$ \\
 $\Delta P^{\star}_{2}=P_{2}-P^{\star}=0.2$bar & $\longleftrightarrow$ & $\Delta H^{\star}_{2}=H_{2}-H^{\star}$ 
\end{tabular}
...
%\begin{center}
     %  $dh = vdp \;\; \textcolor{red}{\Longrightarrow}\;\; \Delta h = v\Delta p \;\;\textcolor{red}{\Longrightarrow}\;\; h_{f_{4}}-h_{f_{3}}=v_{3}\left(p_{1}-p_{2}\right)$ 
       h = vdp \;\; \textcolor{red}{\Longrightarrow}\;\; \Delta h = v\Delta p \;\;\textcolor{red}{\Longrightarrow}\;\; h_{f_{4}}-h_{f_{3}}=v_{3}\left(p_{4}-p_{3}\right)
%\end{center}
\end{displaymath}}
 \normalsize
\end{frame}
