...
\begin{displaymath}
    \frc{dp}{dx} = -180u \frc{\mu\left(1-\phi\right)^{2}}{d_{s}^{2}\phi^{3}},
\end{displaymath}
of an area of 1$\times$1 m$^{2}$. Dynamic viscosity and density of water are 0.89 cP and 998 kg.m$^{-3}$, respectively.
