...
\end{displaymath}
of an area of 1$\times$1 m$^{2}$. Dynamic viscosity $\left(\mu\right)$ and density $\left(\rho\right)$ of water are 0.89 cP and 998 kg.m$^{-3}$, respectively. $z$ is the vertical depth, also the hydrostatic pressure in a fluid can be determined by,
\begin{displaymath}
  p = p_{0} -\rho g z
\end{displaymath}
