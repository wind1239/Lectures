...
%%%
   \begin{frame}
     ...
     \begin{enumerate}[A.]\scriptsize
       ...
       \item <4-> In this \blue{Module}, we will focus on fluid flows in porous media, involving injection and production of geothermal fluids used in the thermodynamic cycles;
       \item <5-> Thus, the aims of this Module are:
          \begin{eenumerate}[(a)]
               \item <6-> Identify heat transfer mechanisms from  
          \end{enumerate} 
 \end{enumerate}
   \end{frame}
